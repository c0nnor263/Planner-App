package com.conboi.features.main.task
...
import com.conboi.core.data.interfaces.dialog.DeadlineDialogCallback
import com.conboi.core.data.interfaces.dialog.ReminderDialogCallback
import com.conboi.features.main.task.dialog.DeadlineDialogFragment
import com.conboi.features.main.task.dialog.ReminderDialogFragment
...
class TaskDetailFragment : Fragment(), ReminderDialogCallback, DeadlineDialogCallback {
    ...
    private fun updateTask() {
        if (viewModel.isEdited()) {
            viewModel.updateTask(
                requireContext(),
                object : UpdateTotalTaskCallback {
    ...
    private fun showRemainingTimeReminderToast(
        day: Long,
        hour: Long,
        minute: Long,
    ) {
    ...
    private fun showRemainingTimeDeadlineToast(
        day: Long,
        hour: Long,
        minute: Long,
    ) {
    ...
    private fun checkedStateUI(state: Boolean) =
        with(binding) {
            if (state) {
