package com.conboi.features.main
...
import com.conboi.core.domain.HOLD_VIBRATION
import com.conboi.core.domain.enums.BottomAction
import com.conboi.core.domain.enums.InsertMultipleTaskError
...
constructor() :
    ...
    override fun onClick(
        view: View,
        id: Int,
    ) = navigateToTaskDetailFragment(id, view)
                ...
                object : ItemTouchHelper.SimpleCallback(
                    ...
                    override fun onChildDraw(
                        ...
                        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                            ...
                            if (dX > 10) {
                                val iconMarginLeft =
                                    (dX * 0.1F).coerceAtMost(80f).coerceAtLeast(10f)
                                c.drawBitmap(
                                    icon!!,
                                    iconMarginLeft,
    ...
    private fun downloadServerList() =
        runBlocking {
    ...
    private fun navigateToTaskDetailFragment(
        ...
        exitTransition =
            MaterialElevationScale(false).apply {
                duration = resources.getInteger(R.integer.reply_motion_duration_large).toLong()
            }
        reenterTransition =
        ...
        val directions =
            MainFragmentDirections.actionMainFragmentToTaskDetailsFragment(
                idTask = id,
            )
