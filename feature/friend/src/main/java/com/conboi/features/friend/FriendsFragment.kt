package com.conboi.features.friend
...
import com.conboi.core.data.interfaces.FriendListInterface
...
class FriendsFragment : BaseTabFragment(), FriendListInterface, InviteFriendDialogCallback {
    ...
    private fun initRv() {
        ...
        val options =
            FirestorePagingOptions.Builder<FriendType>()
    ...
    private fun navigateToFriendDetails(friend: FriendType) {
        ...
        val direction =
            FriendsFragmentDirections.actionFriendsFragmentToFriendDetailsFragment(
                friend = friend,
            )
