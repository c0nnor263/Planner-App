...
import com.conboi.core.domain.PREMIUM_PREFERENCES
...
@Singleton
class PremiumPreferencesDataStore
@Inject
constructor(
    ...
    val preferencesFlow =
        dataStore.data
            .catch { exception ->
                ...
                val premiumType =
                    PremiumType.valueOf(
                        preferences[PremiumPreferencesKeys.PREMIUM_TYPE]
                            ?: PremiumType.STANDARD.name,
                    )
